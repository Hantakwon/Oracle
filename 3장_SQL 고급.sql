...
SELECT COUNT(*) AS 직원수 FROM EMP;
SELECT COUNT(JOB) AS "정직원수" FROM EMP;
...
// 실습 6-2. 외부 조인 실습
SELECT * FROM SALE S LEFT JOIN EMP E ON S.EMPNO = E.EMPNO;
SELECT * FROM SALE S RIGHT JOIN EMP E ON S.EMPNO = E.EMPNO;